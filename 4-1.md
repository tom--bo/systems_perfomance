...
これらのツールは/procファイルシステムを読んでいることが多い
...
システムパフォーマンスの統計情報のメインソースである/procと/sysとkstatがこの後紹介され、Delay accountingとmicrostate accountingが説明し、最後に他のソースについてまとめる。
その後に、DTraceとSystemTapツールが紹介する。
